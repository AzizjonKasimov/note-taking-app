...
/**
 * Verifies the v1 -> v2 migration on a hand-built v1 database: every existing note must survive and
...
class MigrationTest {
    ...
    @Test
    fun migrate1to2_preservesNotes_andAssignsUnfiled() {
        ...
        // Open through Room with the migration: triggers MIGRATION_1_2 and Room's schema validation.
